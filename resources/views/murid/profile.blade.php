...
<form id="profile-pic-form" action="{{ route('murid.updateProfilePic') }}" method="POST" enctype="multipart/form-data" style="display: none;">
    @csrf
  ...
  <div class="row">
    <div class="col-12 col-xl-6 mx-auto">
      <div class="card h-100">
        ...
        <form method="post" action="{{ route('murid.updateprofiles') }}" class="row">
            @csrf
            <div class="mb-3 col-xl-6">
                <label>Kode Profile</label>
                <input type="text" name="kode_profile" class="form-control" value="{{ $murid->kode_profile }}" disabled>
            </div>
            <div class="mb-3 col-xl-6">
                <label>E-mail</label>
            ...
            <div class="mb-3 col-xl-6">
                <label>No Hp</label>
                <input type="text" name="no_hp" class="form-control" minlength="8" maxlength="13" value="{{ $murid->no_hp }}">
            </div>
            <div class="mb-3 col-xl-12">
                <label>Alamat</label>
                <textarea name="alamat" class="form-control" rows="3">{{ $murid->alamat }}</textarea>
            </div>
            <div class="d-flex">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{route('murid.changePassword')}}" method="post">
                @csrf
                <div class="mb-3">
