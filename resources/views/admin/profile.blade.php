...
<form id="profile-pic-form" action="{{ route('admin.updateProfilePic') }}" method="POST" enctype="multipart/form-data" style="display: none;">
  @csrf
    ...
    <div class="col-12 col-xl-6 mx-auto">
      <div class="card h-100">
        ...
        <div class="card-body p-3">
          <form class="row" method="post" action="{{route('admin.updateprofiles')}}">
            @csrf
